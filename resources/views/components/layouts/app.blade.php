...
<body>
    ...
    <div class="fixed left-0 top-0 w-64 h-full bg-[#5f9173] p-4 z-50 sidebar-menu transition-transform">
        ...
        <ul class="mt-4">
            ...
            <span class="text-gray-400 font-bold">Settings</span>
            <li class="mb-1 group">
                <a href="" class="flex font-semibold items-center py-2 px-4 text-gray-900 hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100">
    ...
    <main class="w-full md:w-[calc(100%-256px)] md:ml-64 bg-gray-200 min-h-screen transition-all main">
        ...
        <!-- Content -->
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6 bg-white">
                {{$slot}}
            </div>
        </div>
        <!-- End Content -->
